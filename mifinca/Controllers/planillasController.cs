...
namespace mifinca.Controllers
{
    public class planillasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_empleado,id_finca,fecha_resolucion")] planilla planilla)
        {
            ...
            ViewBag.id_empleado = new SelectList(db.empleado, "id_empleado", "nombre", planilla.id_empleado);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_empleado,id_finca,fecha_resolucion")] planilla planilla)
        {
            if (ModelState.IsValid)
            {
